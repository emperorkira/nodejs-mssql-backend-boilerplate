    ...
    */
    ...
    import { token, default_records, audittrail_fields } from '../shared';
    ...
    */
    export const logUserAction = async (UserId = 0, Action = '', Record = 0, Table = '') => {
        try {
            ...
            const log = await ADD.record(TABLE.t003, audittrail_fields, [Int, NVarChar(50), Int, NVarChar(50), DateTime], [UserId, Action, Record, Table, DateCreated]);
            return log;
        } catch(error) {
