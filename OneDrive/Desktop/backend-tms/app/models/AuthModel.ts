...
const ENCRYPTION:any = process.env.ENCRYPTION_KEY
...
export const AuthModel = {
     ...
     *****************************************************************/
    async getUserByUsername(table:any, Username:any) {
     ...
     *****************************************************************/
    async comparePassword(Password:any, hashedPassword:any) {
     ...
     *****************************************************************/
    async createUser(table:any, recordData:any) {
        const request = new sql.Request()
        if (table === "Ticket") {
